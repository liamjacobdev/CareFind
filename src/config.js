 ...
 *
 * Read from `window.INNETWORK_CONFIG`, a tiny object the page injects before the
 * bundle runs (see the inline config block in innetwork.html). configure_frontend.py
 ...
 */
const C = (typeof window !== 'undefined' && window.INNETWORK_CONFIG) || {};
...
const PLACEHOLDER_CLAIM_EMAIL = 'providers@innetwork.example';
