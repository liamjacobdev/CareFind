...
Validation is strict and uses InNetwork's *own* in-network determination, so an endpoint
...
def render_ledger(results: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "under InNetwork's own determination) and is wired as a VERIFIED (\"Confirmed\") filter",
