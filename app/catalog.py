...
PAYER_CATALOG: list[dict[str, Any]] = [
    ...
    # Johns Hopkins Advantage MD — regional MA plan. Its public Plan-Net endpoint was
    # validated, but regressed (its Practitioners now carry zero PractitionerRoles), so it
    # is currently an ESTIMATE; it re-graduates to verified automatically when its roles
    # return (see app/planet_registry.py).
